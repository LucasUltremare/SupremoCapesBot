...
:options
    ...
    ECHO O SupremoCapes esta em alfa então pega nos seguintes clients:
    ECHO Lunar, Todas as versões optifine e modpack SupremoMc
    ...
    ECHO 2) UnInstall (Remova o SupremoCapes do seu computador)
    ECHO 3) Sair (Fecha o programa)
    REM Take in user input and store it as %OPTION%
    SET /p choice=Digite o número que representa uma opção:
